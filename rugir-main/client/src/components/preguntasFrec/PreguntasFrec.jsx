...
const PreguntasFrecuentes = () => {
  ...
  return (
    <div className={style.container} id='frec'>
      <h4 data-aos="fade-right" data-aos-duration="1000" className={style.titulo} >Preguntas frecuentes</h4>
      {preguntas.map((pregunta) => (
        <div key={pregunta.id} className={style.acordeon} data-aos="fade-right" data-aos-duration="1000">
          <button 
